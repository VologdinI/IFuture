...
public class FileAdvanced {
    ...
    private TextEfficientReader textEfficientReader;
    ...
    public FileAdvanced(File file) {
        ...
        this.ID = lastID;
        textEfficientReader = new TextEfficientReader(file);
    }
    ...
    public TextEfficientReader getTextEfficientReader() {
        return textEfficientReader;
    }
}
